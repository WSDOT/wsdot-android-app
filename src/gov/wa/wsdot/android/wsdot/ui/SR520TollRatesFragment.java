...
public class SR520TollRatesFragment extends ListFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
        ...
        String[][] weekdayData = {
        		...
        		{"5 AM to 6 AM", "$1.75", "$3.35"},
        		{"6 AM to 7 AM", "$3.00", "$4.60"},
        		{"7 AM to 9 AM", "$3.80", "$5.40"},
        		{"9 AM to 10 AM", "$3.00", "$4.60"},
        		{"10 AM to 2 PM", " $2.40", "$4.05"},
        		{"2 PM to 3 PM", "$3.00", "$4.60"},
        		{"3 PM to 6 PM", "$3.80", "$5.40"},
        		{"6 PM to 7 PM", "$3.00", "$4.60"},
        		{"7 PM to 9 PM", "$2.40", "$4.05"},
        		{"9 PM to 11 PM", "$1.75", "$3.35"},
        		{"11 PM to 11:59 PM", "0", "0"}
        		};

        String[][] weekendData = {
        		{"Midnight to 5 AM", "0", "0"},
        		{"5 AM to 8 AM", "$1.20", "$2.80"},
        		{"8 AM to 11 AM", "$1.80", "$3.40"},
        		{"11 AM to 6 PM", "$2.35", "$4.00"},
        		{"6 PM to 9 PM", "$1.80", "$3.40"},
        		{"9 PM to 11 PM", " $1.20", "$2.80"},
        		{"11 PM to 11:59 PM", "0", "0"}
        		};
