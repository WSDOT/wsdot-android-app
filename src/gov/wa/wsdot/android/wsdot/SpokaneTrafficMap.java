...
public class SpokaneTrafficMap extends TrafficMap {
	
	void prepareMap() {
		super.setContentView(R.layout.map);
		((TextView)findViewById(R.id.sub_section)).setText("Spokane Area Traffic");
		
        Double latitude = 47.658566;
        Double longitude = -117.425995;
