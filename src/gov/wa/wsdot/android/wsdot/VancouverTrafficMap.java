...
public class VancouverTrafficMap extends TrafficMap {
	
	void prepareMap() {
		super.setContentView(R.layout.map);
		((TextView)findViewById(R.id.sub_section)).setText("Vancouver Area Traffic");
		
        Double latitude = 45.639968;
        Double longitude = -122.610512;
