...
public class AmtrakCascadesFragment extends BaseListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        listViewItems.add(new ListViewItem("Buy Tickets", "http://m.amtrak.com"));
        listViewItems.add(new ListViewItem("Check Schedules and Status", AmtrakCascadesSchedulesActivity.class));
