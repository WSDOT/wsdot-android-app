...
@Singleton
public class TollRateSignRepository extends NetworkResourceSyncRepository {

    private final static String TAG = TollRateSignRepository.class.getSimpleName();
    ...
    @Inject
    public TollRateSignRepository(TollTripDao tollTripDao,
    ...
    */
    ...
    void fetchData(MutableLiveData<ResourceStatus> status) throws Exception {
        ...
        URL url = new URL( APIEndPoints.I405_TOLL_RATES+ "?accesscode=" + APIEndPoints.WSDOT_API_KEY);
