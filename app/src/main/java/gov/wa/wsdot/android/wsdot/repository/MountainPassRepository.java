...
public class MountainPassRepository extends NetworkResourceRepository {
    ...
    public void fetchData(MutableLiveData<ResourceStatus> status) throws Exception {
        ...
        for (int j=0; j < numConditions; j++) {
            ...
            weather_image_name = getWeatherImage(weatherPhrasesDay, weatherCondition);
            ...
            for (int l=0; l < numForecasts; l++) {
                ...
                if (isNight(forecast.getString("Day"))) {
                    ...
                    forecast_weather_image_name = getWeatherImage(weatherPhrasesDay, forecast.getString("ForecastText"));
                }
            ...
            passData.setElevation(pass.getString("ElevationInFeet"));
    ...
    private static void initWeatherPhrases() {
