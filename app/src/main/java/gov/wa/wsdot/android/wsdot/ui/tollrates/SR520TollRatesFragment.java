...
public class SR520TollRatesFragment extends BaseFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
        ...
        String[][] weekdayData = {
        		...
        		{"5 AM to 6 AM", "$1.90", "$3.90"},
        		{"6 AM to 7 AM", "$3.25", "$5.25"},
        		{"7 AM to 9 AM", "$4.10", "$6.10"},
        		{"9 AM to 10 AM", "$3.25", "$5.25"},
        		{"10 AM to 2 PM", " $2.55", "$4.55"},
        		{"2 PM to 3 PM", "$3.25", "$5.25"},
        		{"3 PM to 6 PM", "$4.10", "$6.10"},
        		{"6 PM to 7 PM", "$3.25", "$5.25"},
        		{"7 PM to 9 PM", "$2.55", "$4.55"},
        		{"9 PM to 11 PM", "$1.90", "$3.90"},
        		{"11 PM to 11:59 PM", "0", "0"}
        		};

        String[][] weekendData = {
        		{"Midnight to 5 AM", "0", "0"},
        		{"5 AM to 8 AM", "$1.30", "$3.30"},
        		{"8 AM to 11 AM", "$1.95", "$3.95"},
        		{"11 AM to 6 PM", "$2.50", "$4.50"},
        		{"6 PM to 9 PM", "$1.95", "$3.95"},
        		{"9 PM to 11 PM", " $1.30", "$3.30"},
        		{"11 PM to 11:59 PM", "0", "0"}
        		};
