...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static final String PREF_ALL_EMERGENCY_ALERTS = "all_emergency_notifications";
    ...
    private void setupActionBar() {
        ...
        if (rootView != null) {
            View view = getLayoutInflater().inflate(R.layout.toolbar_actionbar, rootView, false);
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(PREF_ALL_EMERGENCY_ALERTS));
        }
